...
app.get('/api/chat/get-messages/:chatId', async (req, res) => {
...
// curl -X POST -H "Content-Type: application/json" -H "UserId: VGkotC32IMFVvdIpC3Yn" -d '{"chatId": "EWEFGN@2n23mv", "message": "Hey there!"}' localhost/api/chat/send-message
