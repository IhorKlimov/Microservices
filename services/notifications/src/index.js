...
app.get('/api/notifications/get-notifications/:userId', async (req, res) => {
...
// curl -X POST -H "Content-Type: application/json" -d '{"toUserId": "VGkotC32IMFVvdIpC3Yn", "message": "Test notification!"}' localhost/api/notifications/send-notification
// curl -X GET localhost/api/notifications/get-notifications/VGkotC32IMFVvdIpC3Yn
